...
create table employee( -- table name employee
	empid int auto_increment primary key, -- employee id ; type int ; this primary key is unique must not duplicated
...
insert into employee(firstName, lastName, salary, dep) values ("yassin", "noam", 200, "phisi");

insert into employee(firstName, lastName, salary, dep) values ( "hamza", "noam", 400, "sodo");
